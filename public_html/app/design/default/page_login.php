...
?>
            ...
            <form class="form-signin" method="POST"><INPUT type="hidden" name="act" value="login"/>
                <span id="reauth-email" class="reauth-email"></span>
                <input type="email" id="inputEmail" name="email" class="form-control mb-2" placeholder="E-Mail-Adresse" required autofocus>
                <input type="password" id="inputPassword" name="pwd" class="form-control mb-2" placeholder="Passwort" required>
...
$(document).ready(function() {
    $("INPUT#inputEmail").on("change", function() {
        ...
        if (a.length < 1) {
            ...
            $("#profile-img").attr("src", "https://www.gravatar.com/avatar/' + MD5(a) + '.jpg?d=identicon&s=300");
        }
    });
});
</script>
